...
class LOVD_GenomeVariant extends LOVD_Custom {
    ...
    function buildForm ($sPrefix = '')
    {
        ...
        if (isset($aForm['VariantOnGenome/Remarks'])) {
            ...
            $aFormFiltered['VariantOnGenome/PhenotypeFindings'] = $aForm['VariantOnGenome/PhenotypeFindings'];
        }
    ...
    function getForm ()
    {
        ...
        $this->aFormData = array_merge(
                 ...
                 array(array('Affects function (reported)', '', 'select', 'effect_reported', 1, $_SETT['var_effect'], false, false, false),
