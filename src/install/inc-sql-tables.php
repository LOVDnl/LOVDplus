...
//    ' . $sSettings
   ...
   'CREATE TABLE ' . TABLE_SCHEDULED_IMPORTS . ' (
    ...
    INDEX (created_by),
    INDEX (edited_by),
    CONSTRAINT ' . TABLE_GENE_LISTS . '_fk_diseaseid FOREIGN KEY (diseaseid) REFERENCES ' . TABLE_DISEASES . ' (id) ON DELETE SET NULL ON UPDATE CASCADE,
    ...
    INDEX (created_by),
    INDEX (edited_by),
    CONSTRAINT ' . TABLE_GENE_LISTS_REV . '_fk_diseaseid FOREIGN KEY (diseaseid) REFERENCES ' . TABLE_DISEASES . ' (id) ON DELETE SET NULL ON UPDATE CASCADE,
