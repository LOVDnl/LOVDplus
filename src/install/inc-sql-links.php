...
if ($_INI['instance']['name'] == 'mgha') {
    $aLinkSQL =
        array(
            ...
            'Provenance' => 'INSERT INTO ' . TABLE_LINKS . ' VALUES (008,"Provenance","{upload[1]prov}","<A href=\"https:/variantdatabase.melbournegenomics.org.au/upload/[1].provenance.pdf\" target=\"_blank\">prov</A>","Links to the provenance file for this sample.",0, NOW(), NULL, NULL)',
