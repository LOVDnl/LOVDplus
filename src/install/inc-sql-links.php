...
if ($_INI['instance']['name'] == 'mgha') {
    $aLinkSQL =
        array(
            ...
            'Provenance' => 'INSERT INTO ' . TABLE_LINKS . ' VALUES (008,"Provenance","{upload[1]}","<A href=\"https:/variantdatabase.melbournegenomics.org.au/upload/[1].provenance.pdf\" target=\"_blank\">prov</A>","Links to the provenance file for this sample.",0, NOW(), NULL, NULL)',
            'INSERT INTO ' . TABLE_COLS2LINKS . ' VALUES ("Screening/Provenance", 008)',
            'Gap' => 'INSERT INTO ' . TABLE_LINKS . ' VALUES (009,"Gap","{upload[1]gap}","<A href=\"https://variantdatabase.melbournegenomics.org.au/upload/[1].gap.xlsx\" target=\"_blank\">gap</A>","Link to download the gap coverage plot file for the selected screen.",0, NOW(), NULL, NULL)',
            'INSERT INTO ' . TABLE_COLS2LINKS . ' VALUES ("Screening/Gap", 009)',
            'Summary' => 'INSERT INTO ' . TABLE_LINKS . ' VALUES (010,"Summary","{upload[1]qc}","<A href=\"https://variantdatabase.melbournegenomics.org.au/upload/[1].summary.pdf\" target=\"_blank\">qc</A>","Links to the quality summary file for this sample produced for the pipeline.",0, NOW(), NULL, NULL)',
            'INSERT INTO ' . TABLE_COLS2LINKS . ' VALUES ("Screening/QualityControl", 010)',
