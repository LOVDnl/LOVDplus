                ...
                if (is_array($oData)) {
                    ...
                    foreach ($oData as $key => $val) {
                        ...
                        if (substr($key,0,8) == 'optgroup') {
                            ...
                            print($bInOptGroup ? '' : "\n" . $sNewLine . '</optgroup>');
                            $bInOptGroup = true; // TODO AM Is it worth checking if this is already set to true or just overwrite it each time? The overhead in checking might not be worth it.
