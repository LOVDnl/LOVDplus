...
\section{Version naming}
LOVD\textsuperscript{+} follows the LOVD3 version numbering.
LOVD\textsuperscript{+} 3.0-29 is based on the LOVD 3.0-29 code,
 with the LOVD\textsuperscript{+} additions applied on top.
LOVD\textsuperscript{+} sometimes releases new features or bug fixes after a new major release.
Since LOVD\textsuperscript{+} needs to wait for a new LOVD release to increase the version number,
 these changes are indicated with a letter following the version number.
For instance, LOVD\textsuperscript{+} 3.0-28b consists of the LOVD 3.0-28 code base,
 the LOVD\textsuperscript{+} additions, and then new features or bug fixes added to the
 LOVD\textsuperscript{+} code after the release of LOVD\textsuperscript{+} 3.0-28.
\vskip \baselineskip

Using this versioning scheme, it's possible that, e.g.,
 LOVD\textsuperscript{+} 3.0-28c and LOVD\textsuperscript{+} 3.0-29 have no difference in functionality.
The changes have merely taken place in the LOVD3 backend of the software,
 and not all features of the LOVD3 backend are in use in LOVD\textsuperscript{+}.
